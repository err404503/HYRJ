...
"./cocos2d/core/platform/CCEnum": 112
} ],
3: [ (function(t, e, i) {}), {} ],
4: [ (function(t, e, i) {
...
var E = m.curve;
if (E) {
if ("string" === ("object" == (e = typeof E) ? t(E) : e)) {
f.types.push(E);
continue;
}
if (Array.isArray(E)) {
E[0] === E[1] && E[2] === E[3] ? f.types.push(h.Linear) : f.types.push(h.Bezier(E));
continue;
}
}
...
for (var S, A, x = f.ratios, w = !0, I = 1, O = x.length; I < O; I++) {
S = x[I] - x[I - 1];
if (1 === I) A = S; else if (Math.abs(S - A) > 1e-6) {
w = !1;
break;
}
}
...
var b = c.events;
if (b) for (var C, T = 0, E = b.length; T < E; T++) {
if (!C) {
(C = new d()).target = i;
a.push(C);
}
var S, A = b[T], x = A.frame / n.duration, w = _(C.ratios, x);
if (w >= 0) S = C.events[w]; else {
S = new f();
C.ratios.push(x);
C.events.push(S);
}
...
function r(t, e) {
var i = (function(t, e) {
var i, n, r, u, d = e - 0, f = e - t[0], p = 3 * d, _ = 3 * f, g = 3 * (e - t[2]), v = 1 / (-d + _ - g + (e - 1)), y = (p - 6 * f + g) * v, m = y * (1 / 3), b = (-p + _) * v, C = 1 / 3 * (3 * b - y * y), T = C * (1 / 3), E = (2 * y * y * y - 9 * y * b + d * v * 27) / 27, S = E / 2, A = S * S + T * T * T;
if (A < 0) {
var x = 1 / 3 * -C, w = l(x * x * x), I = -E / (2 * w), O = c(I < -1 ? -1 : I > 1 ? 1 : I), N = 2 * o(w);
n = N * s(O * (1 / 3)) - m;
r = N * s((O + h) * (1 / 3)) - m;
u = N * s((O + 2 * h) * (1 / 3)) - m;
...
var C, T = t[m], E = f[m], S = f[m + 1] - E, A = u[m], x = u[m + 1], w = d[m], I = [], O = v / S, N = 1 / (S * i * o);
if (T && T.length > 0) {
var L = [];
L.push(r(A));
...
var F, j, z, W;
if ((C = c(C = O, w)) < 0) {
W = (0 - C) * (j = D.beziers[0]).getLength();
z = j.start.sub(j.endCtrlPoint).normalize();
F = j.start.add(z.mul(W));
} else if (C > 1) {
W = (C - 1) * (j = D.beziers[D.beziers.length - 1]).getLength();
...
for (R = 0, P = I.length; R < P; R++) {
var V = E + v + N * R * S;
a(I[R], y, V);
}
v = Math.abs(O - 1) > 1e-6 ? (O - 1) * S : 0;
}
...
"./utils/base-node": 132,
"./utils/misc": 136,
"./utils/prefab-helper": 138,
"./utils/scene-graph-helper": 139
} ],
24: [ (function(t, e, i) {
cc.Scene = cc.Class({
name: "cc.Scene",
...
var S = e._isAbsHorizontalCenter ? e._horizontalCenter : e._horizontalCenter * b, A = (.5 - f.x) * a.width;
if (c) {
S *= s.x;
A += r.x;
A *= s.x;
...
var R = e._isAbsVerticalCenter ? e._verticalCenter : e._verticalCenter * I, P = (.5 - f.y) * a.height;
if (c) {
R *= s.y;
P += r.y;
P *= s.y;
...
var T = l * (1 - C) * h.width;
if (e) {
var E = f + T + l * (l > 0 ? this.paddingRight : this.paddingLeft), S = this.horizontalDirection === c.LEFT_TO_RIGHT && E > (1 - a.x) * t, A = this.horizontalDirection === c.RIGHT_TO_LEFT && E < -a.x * t;
if (S || A) {
if (h.height >= _) {
0 === g && (g = _);
p += g;
...
if (e) {
var E = f + T + l * (l > 0 ? this.paddingTop : this.paddingBottom), S = this.verticalDirection === s.BOTTOM_TO_TOP && E > (1 - a.y) * t, A = this.verticalDirection === s.TOP_TO_BOTTOM && E < -a.y * t;
if (S || A) {
if (h.width >= _) {
0 === g && (g = _);
p += g;
...
C.cloneable_DEV, i("./attribute")), E = T.DELIMETER, S = T.getTypeChecker, A = i("./preprocess-class");
i("./requiring-frame");
...
return cc.Class(n);
})), C = f(c), T = d(v, "requireComponent"), E = f(y), S = d(m, "executionOrder"), A = f(c), x = f(c), w = f(y), I = f(y), O = f(y);
...
if (p[b + f]) {
var E = p[b + f];
T = c.IDENTIFIER_RE.test(E) ? "." + E : "[" + c.escapeForJS(E) + "]";
}
g.push("prop=d" + T + ";");
g.push('if(typeof (prop)!=="undefined"){');
var S = c.getDefault(p[b + u]);
if (v) {
var A = "object" == (e = typeof S) ? t(S) : e;
"string" === A && !p[b + d] || "number" === A || "boolean" === A ? g.push("o" + C + "=prop;") : h(g, S, C, m, !0);
} else {
...
this.codeArray.push(E + S + "," + A + ";", "if(R){", S + "=R;", "}else{", S + "=R=new " + this.getFuncModule(t.constructor, !0) + "();", "}");
t._iN$t = {
globalVar: "R"
};
...
var i;
this.globalVariables.length > 0 && (i = E + this.globalVariables.join(",") + ";");
...
var d = i("./CCObject"), f = d.Flags.Destroyed, p = d.Flags.PersistentMask, _ = i("./attribute"), g = i("./js"), v = i("./CCClass"), y = i("./compiler"), m = _.DELIMETER + "serializable", b = _.DELIMETER + "default", C = v.IDENTIFIER_RE, T = v.escapeForJS, E = "var ", S = "o", A = "t", x = {
"cc.Node": "cc.Node",
"cc.Sprite": "cc.Sprite",
"cc.Label": "cc.Label",
"cc.Button": "cc.Button",
...
return E + this.varName + "=" + this.expression + ";";
};
...
"../utils/mutable-forward-iterator": 137,
"./id-generater": 122
} ],
127: [ (function(i, n, o) {
function r(t, e, i, n) {
...
"./cocos2d/particle/CCParticleAsset": 151,
"./cocos2d/particle/CCParticleSystem": 152,
...
"./extensions/spine": 1,
"./external/chipmunk/chipmunk": 156
} ],
154: [ (function(t, e, i) {
...
var s = i - o, c = n - r, a = m(E(s, c, t - o, e - r) / F(s, c));
...
n += u * (E(c, a, c, a) + E(c, a, h, l) + E(h, l, h, l));
o += u;
}
return t * n / (6 * o);
};
...
if (0 === i) return 0;
for (var s = 0, c = e, a = w(o, n), h = r * S(a), l = e, u = e + i - 1; l <= u; ) {
...
return t * n - e * i;
}, R = cp.v.perp = function(t) {
return new b(-t.y, t.x);
}, P = (cp.v.pvrperp = function(t) {
return new b(t.y, -t.x);
...
return O(t, 1 / S(t));
}, W = cp.v.normalize_safe = function(t) {
return 0 === t.x && 0 === t.y ? C : z(t);
}, k = cp.v.clamp = function(t, e) {
return T(t, t) > e * e ? O(z(t), e) : t;
}, V = (cp.v.lerpconst = function(t, e, i) {
return x(t, k(w(e, t), i));
}, cp.v.dist = function(t, e) {
return S(w(t, e));
}), H = cp.v.distsq = function(t, e) {
return M(w(t, e));
}, U = (cp.v.near = function(t, e, i) {
return H(t, e) < i * i;
...
return t;
}), G = (cp.v.slerpconst = function(t, e, i) {
var n = Math.acos(T(t, e));
return U(t, e, r(i, n) / n);
...
}, X = 0, Q = (cp.NO_GROUP = 0, cp.ALL_LAYERS = -1);
...
K.prototype.hitPoint = function(t, e) {
return j(t, e, this.t);
};
K.prototype.hitDist = function(t, e) {
return V(t, e) * this.t;
};
var J = cp.CircleShape = function(t, e, i) {
this.c = this.tc = i;
this.r = e;
this.type = "circle";
q.call(this, t);
...
J.prototype.cacheData = function(t, e) {
...
if (0 <= h && h <= 1) return new K(t, h, z(j(n, o, h)));
}
};
J.prototype.segmentQuery = function(t, e) {
...
if (u * d < 0) return new K(this, u / (u - d), r);
} else if (0 !== o) {
...
for (var s = 0; s < o; s += 2) {
var a = i[s] + n.x, h = i[s + 1] + n.y, l = i[(s + 2) % o] + n.x, u = i[(s + 3) % o] + n.y, d = z(R(new b(l - a, u - h)));
this.verts[s] = a;
this.verts[s + 1] = h;
this.planes[s >> 1] = new nt(d, E(d.x, d.y, a, h));
this.tPlanes[s >> 1] = new nt(new b(0, 0), 0);
}
};
cp.BoxShape = function(t, e, i) {
var n = e / 2, o = i / 2;
return ot(t, new G(-n, -o, n, o));
};
...
if (f <= d && d <= p) return new K(this, l, c);
}
}
}
};
it.prototype.valueOnAxis = function(t, e) {
for (var i = this.tVerts, n = E(t.x, t.y, i[0], i[1]), o = 2; o < i.length; o += 2) n = r(n, E(t.x, t.y, i[o], i[o + 1]));
return n - e;
};
it.prototype.containsVert = function(t, e) {
for (var i = this.tPlanes, n = 0; n < i.length; n++) {
var o = i[n].n;
if (E(o.x, o.y, t, e) - i[n].d > 0) return !1;
}
return !0;
};
...
var r = n[o].n;
if (!(T(r, i) < 0)) {
if (E(r.x, r.y, t, e) - n[o].d > 0) return !1;
}
}
return !0;
};
...
return x(new b(this.vx, this.vy), O(R(t), this.w));
};
...
return NodeNew(t, At(t, e, i, E - i), At(t, e, E, l - E));
};
...
c.tMass = 1 / $t(n, o, c.r1, c.r2, R(c.n));
c.bias = -i * r(0, c.dist + e) / t;
c.jBias = 0;
c.bounce = Qt(n, o, c.r1, c.r2, c.n) * this.e;
}
};
...
0;
var r = this.contacts[o], c = r.nMass, a = r.n, h = r.r1, l = r.r2, u = e.vx - l.y * e.w - (t.vx - h.y * t.w), d = e.vy + l.x * e.w - (t.vy + h.x * t.w), f = a.x * (e.v_biasx - l.y * e.w_bias - t.v_biasx + h.y * t.w_bias) + a.y * (l.x * e.w_bias + e.v_biasy - h.x * t.w_bias - t.v_biasy), p = E(u, d, a.x, a.y), _ = E(u + i.x, d + i.y, -a.y, a.x), g = (r.bias - f) * c, v = r.jBias;
r.jBias = s(v + g, 0);
var m = -(r.bounce + p) * c, b = r.jnAcc;
r.jnAcc = s(b + m, 0);
var C = n * r.jnAcc, T = -_ * r.tMass, S = r.jtAcc;
r.jtAcc = y(S + T, -C, C);
var A = a.x * (r.jBias - v), x = a.y * (r.jBias - v);
Kt(t, -A, -x, h);
Kt(e, A, x, l);
var w = r.jnAcc - b, I = r.jtAcc - S;
Zt(t, e, h, l, a.x * w - a.y * I, a.x * I + a.y * w);
}
};
...
var l = a[h], d = a[h + 1];
if (E(l, d, c.x, c.y) < T(e.tn, e.ta) * o + e.r) {
var f = L(e.tn.x, e.tn.y, l, d);
r >= f && f >= s && t.push(new Lt(new b(l, d), c, n, u(i.hashid, h)));
}
}
};
J.prototype.collisionCode = 0;
tt.prototype.collisionCode = 1;
it.prototype.collisionCode = 2;
J.prototype.collisionTable = [ function(t, e) {
var i = Pt(t.tc, e.tc, t.r, e.r);
return i ? [ i ] : Rt;
}, function(t, e) {
var i = e.ta, n = e.tb, o = t.tc, r = w(n, i), s = m(T(r, w(o, i)) / M(r)), c = x(i, O(r, s)), a = Pt(o, c, t.r, e.r);
if (a) {
var h = a.n;
return 0 === s && T(h, e.a_tangent) < 0 || 1 === s && T(h, e.b_tangent) < 0 ? Rt : [ a ];
}
return Rt;
}, function(t, e) {
...
if (v < g) return (y = Pt(t.tc, new b(f, p), t.r, 0)) ? [ y ] : Rt;
if (v < _) return [ new Lt(w(t.tc, O(c, t.r + o / 2)), I(c), o, 0) ];
var y;
return (y = Pt(t.tc, new b(u, d), t.r, 0)) ? [ y ] : Rt;
} ];
...
if (g = Pt(t.ta, m, t.r, 0)) return [ g ];
if (g = Pt(t.tb, m, t.r, 0)) return [ g ];
var C = 2 * o, E = new b(y[(v + 2) % C], y[(v + 3) % C]);
if (g = Pt(t.ta, E, t.r, 0)) return [ g ];
if (g = Pt(t.tb, E, t.r, 0)) return [ g ];
}
return i;
} ];
...
}, Wt = new wt(), kt = cp.Space = function() {
this.stamp = 0;
this.curr_dt = 0;
this.bodies = [];
this.rousedBodies = [];
...
kt.prototype.getCurrentTimeStep = function() {
return this.curr_dt;
};
kt.prototype.setIterations = function(t) {
this.iterations = t;
};
kt.prototype.isLocked = function() {
return this.locked;
};
var Vt = function(t) {
...
kt.prototype.addCollisionHandler = function(t, e, i, n, o, r) {
Vt(this);
...
kt.prototype.removeCollisionHandler = function(t, e) {
Vt(this);
delete this.collisionHandlers[u(t, e)];
};
kt.prototype.setDefaultCollisionHandler = function(t, e, i, n) {
Vt(this);
var o = new wt();
t && (o.begin = t);
e && (o.preSolve = e);
...
kt.prototype.lookupHandler = function(t, e) {
...
kt.prototype.addStaticShape = function(t) {
c(!t.space, "This shape is already added to a space and cannot be added to another.");
Vt(this);
var e = t.body;
e.addShape(t);
...
kt.prototype.addBody = function(t) {
...
kt.prototype.addConstraint = function(t) {
c(!t.space, "This shape is already added to a space and cannot be added to another.");
Vt(this);
var e = t.a, i = t.b;
e.activate();
...
kt.prototype.filterArbiters = function(t, e) {
...
kt.prototype.removeShape = function(t) {
var e = t.body;
...
kt.prototype.removeStaticShape = function(t) {
...
kt.prototype.removeBody = function(t) {
...
kt.prototype.removeConstraint = function(t) {
...
kt.prototype.containsShape = function(t) {
return t.space === this;
};
kt.prototype.containsBody = function(t) {
return t.space == this;
};
kt.prototype.containsConstraint = function(t) {
return t.space == this;
};
kt.prototype.uncacheArbiter = function(t) {
delete this.cachedArbiters[u(t.a.hashid, t.b.hashid)];
d(this.arbiters, t);
};
kt.prototype.eachBody = function(t) {
this.lock();
...
kt.prototype.eachShape = function(t) {
this.lock();
this.activeShapes.each(t);
this.staticShapes.each(t);
this.unlock(!0);
};
kt.prototype.eachConstraint = function(t) {
this.lock();
for (var e = this.constraints, i = 0; i < e.length; i++) t(e[i]);
this.unlock(!0);
};
kt.prototype.reindexStatic = function() {
...
kt.prototype.reindexShape = function(t) {
c(!this.locked, "You cannot manually reindex objects while the space is locked. Wait until the current query or step is complete.");
var e = t.body;
t.update(e.p, e.rot);
...
kt.prototype.reindexShapesForBody = function(t) {
for (var e = t.shapeList; e; e = e.next) this.reindexShape(e);
};
kt.prototype.useSpatialHash = function(t, e) {
throw new Error("Spatial Hash not implemented.");
};
kt.prototype.activateBody = function(t) {
...
kt.prototype.deactivateBody = function(t) {
...
for (var n = e.arbiterList; n; n = n.next(e)) Ut(t, e == n.body_a ? n.body_b : n.body_a);
for (var o = e.constraintList; o; o = o.next(e)) Ut(t, e == o.a ? o.b : o.a);
...
kt.prototype.processComponents = function(t) {
...
if (null === Ht(o)) {
Ut(o, o);
if (!Gt(o, this.sleepTimeThreshold)) {
...
if (this.isSleeping()) c(Ht(this) === Ht(t), "The body is already sleeping and it's group cannot be reassigned."); else {
...
kt.prototype.nearestPointQuery = function(t, e, i, n, o) {
var r = function(r) {
...
kt.prototype.nearestPointQueryNearest = function(t, e, i, n) {
var o, r = function(r) {
...
kt.prototype.segmentQuery = function(t, e, i, n, o) {
var r = function(r) {
var s;
...
kt.prototype.segmentQueryFirst = function(t, e, i, n) {
...
kt.prototype.bbQuery = function(t, e, i, n) {
var o = function(o) {
...
kt.prototype.shapeQuery = function(t, e) {
var i = t.body;
i && t.update(i.p, i.rot);
var n = new G(t.bb_l, t.bb_b, t.bb_r, t.bb_t), o = !1, r = function(i) {
var n = t;
...
kt.prototype.addPostStepCallback = function(t) {
...
kt.prototype.runPostStepCallbacks = function() {
for (var t = 0; t < this.postStepCallbacks.length; t++) this.postStepCallbacks[t]();
this.postStepCallbacks = [];
};
kt.prototype.lock = function() {
this.locked++;
};
kt.prototype.unlock = function(t) {
this.locked--;
...
kt.prototype.makeCollideShapes = function() {
var t = this;
return function(e, i) {
var n = t;
...
kt.prototype.arbiterSetFilter = function(t) {
...
return E(c - r, a - s, o.x, o.y);
}, qt = function(t, e, i, n) {
t.vx += e * t.m_inv;
t.vy += i * t.m_inv;
t.w += t.i_inv * (n.x * i - n.y * e);
}, Zt = function(t, e, i, n, o, r) {
qt(t, -o, -r, i);
qt(e, o, r, n);
}, Kt = function(t, e, i, n) {
t.v_biasx += e * t.m_inv;
...
var n = w(x(i.p, this.r2), x(e.p, this.r1)), o = S(n);
...
Zt(this.a, this.b, this.r1, this.r2, e.x, e.y);
};
oe.prototype.applyImpulse = function() {
var t = this.a, e = this.b, i = this.n, n = Qt(t, e, this.r1, this.r2, i), o = (this.bias - n) * this.nMass, r = this.jnAcc;
this.jnAcc = y(r + o, -this.jnMax, this.jnMax);
o = this.jnAcc - r;
Zt(t, e, this.r1, this.r2, i.x * o, i.y * o);
};
...
this.r1 = B(this.anchr1, e.rot);
this.r2 = B(this.anchr2, i.rot);
var n = w(x(i.p, this.r2), x(e.p, this.r1)), o = S(n), r = 0;
if (o > this.max) {
r = o - this.max;
this.n = W(n);
} else if (o < this.min) {
...
var e = this.jnAcc * t;
Zt(this.a, this.b, this.r1, this.r2, this.n.x * e, this.n.y * e);
};
...
c = this.jnAcc - a;
Zt(t, e, this.r1, this.r2, i.x * c, i.y * c);
}
};
...
this.bias = k(O(n, -ie(this.errorBias, t) / t), this.maxBias);
};
se.prototype.applyCachedImpulse = function(t) {
Zt(this.a, this.b, this.r1, this.r2, this.jAcc.x * t, this.jAcc.y * t);
};
...
this.jAcc = k(x(this.jAcc, r), this.jMaxLen);
Zt(t, e, this.r1, this.r2, this.jAcc.x - s.x, this.jAcc.y - s.y);
};
...
this.clamp = 0;
this.r1 = w(x(O(R(r), -c), O(r, s)), e.p);
}
te(e, i, this.r1, this.r2, this.k1, this.k2);
this.jMaxLen = this.maxForce * t;
var a = w(x(i.p, this.r2), x(e.p, this.r1));
this.bias = k(O(a, -ie(this.errorBias, t) / t), this.maxBias);
};
ce.prototype.applyCachedImpulse = function(t) {
Zt(this.a, this.b, this.r1, this.r2, this.jAcc.x * t, this.jAcc.y * t);
};
ce.prototype.grooveConstrain = function(t) {
var e = this.grv_tn, i = this.clamp * N(t, e) > 0 ? t : P(t, e);
return k(i, this.jMaxLen);
};
...
this.grv_a = t;
this.grv_n = R(z(w(this.grv_b, t)));
this.activateBodies();
};
ce.prototype.setGrooveB = function(t) {
this.grv_b = t;
this.grv_n = R(z(w(t, this.grv_a)));
this.activateBodies();
};
var ae = function(t, e) {
...
Zt(e, i, this.r1, this.r2, this.n.x * s * t, this.n.y * s * t);
};
he.prototype.applyCachedImpulse = function(t) {};
he.prototype.applyImpulse = function() {
var t = this.a, e = this.b, i = this.n, n = this.r1, o = this.r2, r = Qt(t, e, n, o, i), s = (this.target_vrn - r) * this.v_coef;
this.target_vrn = r + s;
s *= this.nMass;
Zt(t, e, this.r1, this.r2, this.n.x * s, this.n.y * s);
};
...
"../cocos2d/core/platform/CCMacro": 113,
"../cocos2d/core/platform/js": 126,
"../cocos2d/core/utils/find": 135,
"../cocos2d/core/utils/mutable-forward-iterator": 137,
...
"../cocos2d/core/platform/CCClass": 110
} ],
171: [ (function(t, e, i) {
"use strict";
if (!cc.runtime) {
